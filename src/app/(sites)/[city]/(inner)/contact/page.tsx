...
// contactMeta carries no city text today, but the city must never be resolved
// at MODULE scope — the city comes from this request's [city] param (async),
// and a module-scope call would freeze the first tenant process-wide. Same
// generateMetadata() shape as the four sibling pages.
