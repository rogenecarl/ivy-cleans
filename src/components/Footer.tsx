...
// post-2342.css d9d7ebf / 0c4df07: row gap split as padding-bottom + margin-top
const itemClass =
...
export default function Footer({
  ...
  // built by (front)/layout.tsx so they go through cityHref
  ...
  return (
    ...
    <footer className="bg-brand pb-[1rem] text-white md:py-[2rem] lg:py-[5rem]">
      <div className="ec">
        {/* post-2342.css: columns 17.769% / 23.462% / 29.768% / 29.001% */}
        <div className="mb-[1rem] flex flex-wrap md:mb-[4rem]">
          <div className="w-full p-[10px] md:w-[17.769%]">
            <Image
              ...
              width={165}
              height={84}
              /* logo max-width 16rem, 10rem at <=1024; a width so the box is reserved before load */
        ...
        {/* 2db93df divider: 15px around a 1px rule, 3rem below */}
