...
// live wraps only the first paragraph's mid-sentence "Ivy Cleans" in <strong>; done at render so the data string stays verbatim
...
export default function Hero({
  ...
  return (
    ...
    >
      ...
      />
      {/* post-2035.css 616760b: 54.848% >=1441, 50% 1025-1440, 100% below; the column owns the 10px gutter */}
      <div className="relative mx-auto max-w-[132rem]">
        <div className="p-[10px] lg:w-[50%] 2xl:w-[54.848%]">
          ...
          {/* 985f4a8: margin-bottom -3.5rem leaves 0.5rem of the widget spacing */}
          ...
          {/* a div, not a <p>: globals.css's unlayered p rule would beat leading-[1.2em]. Icon box 3rem + 25% margin */}
