...
export const nearMe: string[] = [
  ...
  "That being said, if you’re interested in top-tier cleaning services in Minneapolis, don’t hesitate to let us know. We would love to make sure that your house gets the attention it deserves because those are the values that have been instilled in our company since our inception.",
];
...
export const featuresOutro: string =
  "Ivy Cleans is committed to providing exceptional cleaning services in Minneapolis throughout homes, apartments and offices. Our services are personalized, eco-friendly, and affordable. Our highly-trained staff takes pride in their work and always goes the extra mile to ensure that your home is thoroughly cleaned and disinfected.";

export const houseCleaning: string[] = [
  "At Ivy Cleans, our passion for providing high-quality house cleaning services in Minneapolis is unmatched. Our team prides itself on professionalism, and we prioritize the trust and reliability which come with inviting cleaning professionals into your home. As a reliable, professional, and trustworthy house cleaning service in Minneapolis, we are the clear choice for anyone seeking top-notch service.",
  "That being said, if you’re thinking about enlisting the services of a professional cleaning team in Minneapolis, don’t hesitate to let us know. It’s only through acting on our company’s deeply-held values that we can ensure your home gets the attention it richly deserves.",
...
export const zipParagraph: string =
...
export const landmarksParagraph: string =
