...
export const moveOutMeta = {
  title: "Minneapolis Move Out Cleaning Services - Ivy Cleans",
  description:
    "Looking for a reliable move-out cleaning service in Minneapolis? Look no further than IVYCleans! We understand that moving out of a house can be a daunting",
};

export const moveHero: { h1: string; paragraphs: string[] } = {
  h1: "Minneapolis Move Out Cleaning Services",
  paragraphs: [
    "Looking for a reliable move-out cleaning service in Minneapolis? Look no further than IVYCleans! We understand that moving out of a house can be a daunting task, and cleaning the entire property before you leave can add to the stress. That’s why we offer comprehensive Minneapolis move-out cleaning services to make the transition easier for you.",
    ...
    "Our move-out cleaning service in Minneapolis includes dusting and wiping all surfaces, cleaning the floors, removing cobwebs, cleaning bathrooms and kitchens, emptying all trash cans and disposing of trash, cleaning windows and mirrors, cleaning light fixtures and switches, and much more.",
...
export const whyIvy: {
  ...
  qualities: [
    ...
    {
      title: "Expertise",
      text: "IVYCleans has years of experience in providing move-out cleaning services in Minneapolis. We have honed our skills over the years and can tackle even the most challenging cleaning tasks. our expertise ensures that the job is done efficiently and effectively, saving you time and energy.",
...
export const cost: { h2: string; paragraphs: string[] } = {
  ...
  paragraphs: [
    ...
    "IVYCleans is committed to providing top-quality move-out cleaning services in Minneapolis. Schedule your cleaning appointment today to ensure your property is left spotless before you leave.",
  ],
};
